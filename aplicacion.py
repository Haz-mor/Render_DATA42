    ...
    try:
        ...
        with col1:
            ...
            hist_plot01 = px.histogram(
                df, x=v[0], title=f"Distribucion {v[0]}", color="species")
        ...
        with col2:
            ...
            hist_plot02 = px.histogram(
                df, x=v[1], title=f"Distribucion {v[1]}", color="species")
        ...
        disp_plot = px.scatter(
            df, x=v[0], y=v[1], color="species", title=f"Dispercion {v[1]} vs. {v[0]}")
